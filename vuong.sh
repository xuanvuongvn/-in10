...
read -p "Dan authtoken vao day (Copy and Ctrl+V to paste then press Enter): " CRP
./ngrok authtoken $CRP 
...
echo ================================
echo Script by XUAN VUONG
echo Cell: 
echo Email: vuongcf@gmail.com@gmail.com
echo Website: xuanvuong.com
echo ================================
